...
import 'package:lab02/bloc/registration/registration_cubit.dart';
...
class RegistrationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => RegistrationCubit(context.read<UserService>()),
      child: Scaffold(
        appBar: AppBar(
          title: const Text(
            'Реєстрація',
                    ...
                    onFocusChange: (value) async {
                      if (!value) {
                        context
                            ...
                            .checkUserExists(emailController.text.trim());
                      }
                    },
                    child: BlocBuilder<RegistrationCubit, RegistrationState>(
                      builder: (context, state) {
                        if (state is UserExists && state.exists) {
